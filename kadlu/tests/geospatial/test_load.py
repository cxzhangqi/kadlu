...
def test_load_single_chs_file():
    ...
    bathy, lats, lons = geo.load_bathy(storage_location=folder, latlon_SW=LatLon(43,-60), latlon_NE=LatLon(44,-59), source="CHS")
...
def test_load_multiple_chs_files():
    folder = os.path.join(path_to_assets, "tif")
    bathy1, lats1, lons1 = geo.load_bathy(storage_location=folder, latlon_SW=LatLon(43,-60), latlon_NE=LatLon(44,-59), source="CHS")
    bathy2, lats2, lons2 = geo.load_bathy(storage_location=folder, latlon_SW=LatLon(44,-60), latlon_NE=LatLon(45,-59), source="CHS")
    bathy12, lats12, lons12 = geo.load_bathy(storage_location=folder, latlon_SW=LatLon(43,-60), latlon_NE=LatLon(45,-59), source="CHS")
...
def test_load_partial_chs_file():
    folder = os.path.join(path_to_assets, "tif")
    bathy, lats, lons = geo.load_bathy(storage_location=folder, latlon_SW=LatLon(43,-60), latlon_NE=LatLon(43.5,-59.5), source="CHS")
